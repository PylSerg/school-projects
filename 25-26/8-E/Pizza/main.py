...
price_1 = Entry(root, font="Arial 12 normal", bg="sky blue", justify="center")
price_1.insert(END, "75")
price_2 = Entry(root, font="Arial 12 normal", bg="sky blue", justify="center")
price_2.insert(END, "12")
price_3 = Entry(root, font="Arial 12 normal", bg="sky blue", justify="center")
price_3.insert(END, "16")
price_4 = Entry(root, font="Arial 12 normal", bg="sky blue", justify="center")
price_4.insert(END, "8")

scale_1 = Scale(root, orient=HORIZONTAL, length=50, from_=0, to=10)
scale_2 = Scale(root, orient=HORIZONTAL, length=50, from_=0, to=10)
scale_3 = Scale(root, orient=HORIZONTAL, length=50, from_=0, to=10)
scale_4 = Scale(root, orient=HORIZONTAL, length=50, from_=0, to=10)
